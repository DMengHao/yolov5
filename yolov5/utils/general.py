...
LOGGER = set_logging('yolov5')  # define globally (used in Task2_train.py, Task2_val.py, detect.py, etc.)
...
def strip_optimizer(f='ws_02.pt', s=''):  # from utils.general import *; strip_optimizer()
